...
export function _fromBase64(s: string, { alphabet, onInvalidInput }: FromBase64Options = {}) {
  ...
  if (!stdByteLookup) {
    ...
    stdByteLookup[9] = stdByteLookup[10] = stdByteLookup[12] = stdByteLookup[13] = stdByteLookup[32] =  // tab, \n, \f, \r, space
      urlByteLookup[9] = urlByteLookup[10] = urlByteLookup[12] = urlByteLookup[13] = urlByteLookup[32] =
      anyByteLookup[9] = anyByteLookup[10] = anyByteLookup[12] = anyByteLookup[13] = anyByteLookup[32] = 64;  // 64 means: whitespace
